...
<div class="form-group form-group row">
	...
	<div class="col-md-5">
		<input type="text" name="nama_produk" id="nama_produk" class="form-control" placeholder="Nama Produk" value="<?php echo set_value('nama_produk') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="text" name="kode_produk" id="kode_produk" class="form-control" placeholder="Kode Produk" value="<?php echo set_value('kode_produk') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="number" name="harga" id="harga" class="form-control" placeholder="Harga Produk" value="<?php echo set_value('harga') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="number" name="stok" id="stok" class="form-control" placeholder="Stok Produk" value="<?php echo set_value('stok') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="text" name="berat" id="berat" class="form-control" placeholder="Berat Produk" value="<?php echo set_value('berat') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-5">
		<input type="text" name="ukuran" id="ukuran" class="form-control" placeholder="Ukuran Produk" value="<?php echo set_value('ukuran') ?>" required>
	</div>
</div>
<hr>
...
<div class="form-group row">
	...
	<div class="col-md-8">
		<textarea name="keywords" id="keywords" class="form-control" placeholder="Keyword (untuk SEO google)"><?php echo set_value('keywords') ?></textarea>
	</div>
</div>
<hr>
