	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/kategori/delete/'.$kategori->id_kategori) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Data ini akan dihapus. Anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
			</td>
		</tr>
		<?php $no++;} ?>
	</tbody>
