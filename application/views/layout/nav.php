...
<div class="wrap_header">
	...
	<div class="header-icons">
		...
		<?php if($this->session->userdata('email')) { ?>
			<a href="<?php echo base_url('dasbor') ?>" class="header-wrapicon1 dis-block ml-4">
		...
		<?php }else{ ?>
			...
			<a href="<?php echo base_url('registrasi') ?>" class="header-wrapicon1 dis-block">
				<div class="btn btn-sm" style="border-radius: 50px; padding: 5px 20px; background-color: #783C00; color: white;">Daftar</div>
			</a>
