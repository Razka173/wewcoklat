...
<div class="container m-l-30">
    <div class="row">
        ...
        <div class="col-sm-6 col-md-8 col-lg-10 p-b-50 konten">
            ...
            <h2 class="text-center">TOTAL TAGIHAN: </h2>
            <h1 class="text-center m-t-50">Rp<?php echo number_format($header_transaksi->jumlah_transaksi,'0',',',',') ?></h2>

            <?php
            foreach( $rekening as $rekening ) {
            ?>
                <h2 class="text-center m-t-50"><?php echo $rekening->nama_bank . " - " ?><strong><?php echo $rekening->nomor_rekening ?></strong></h2>
